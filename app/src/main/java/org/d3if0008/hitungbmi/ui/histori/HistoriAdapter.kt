...
import org.d3if0008.hitungbmi.data.HitungBmi
import org.d3if0008.hitungbmi.databinding.ItemHistoriBinding
import org.d3if0008.hitungbmi.db.BmiEntity
...
class HistoriAdapter : RecyclerView.Adapter<HistoriAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bind(item: BmiEntity) = with(binding) {
            ...
            beratTextView.text = root.context.getString(
                R.string.berat_x,
                item.berat
            )
            tinggiTextView.text = root.context.getString(
                R.string.tinggi_x,
                item.tinggi
            )
